  ...
  <div class="relative px-4 sm:px-6 lg:px-8">
    <div class="text-lg max-w-prose mx-auto">
      <h1>
        ...
        <span class="font-laila mt-2 pb-1.5 block text-4xl text-center leading-8 font-semibold tracking-tight text-transparent bg-clip-text bg-gradient-to-tr from-yellow-400 to-yellow-100 sm:text-5xl">Moonlight Grant</span>
      </h1>
    </div>
    <div class="mt-8 prose prose-gray prose-lg text-gray-100 mx-auto">
      <p>After the sun goes down, something amazing happens. There is a group of people who keep running forward … long after all the others have quit. Dreamers who dare to keep building and learning push forward into the wee hours of the night, toiling away by <strong class="text-yellow-200 underline underline-offset-4 decoration-2 decoration-wavy decoration-yellow-200">moonlight</strong> to create incredible things.</p>
    ...
    <div class="mt-16 text-lg max-w-prose mx-auto text-right">
      <div class="mr-6 sm:mr-24">
        <svg class="h-16 stroke-slate-300 ml-auto mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 182 44" stroke="currentColor" stroke-width="2.5" aria-hidden="true">
          ...
          <path d="M131.5 32.8s4-.2 8.4-1c2.4-.4 5-1.7 7.8-1.8 2.9-.1 1.8 1.4 3.6 1.4l15-.7c6.9-.4 9.7-2.8 12.8-1 1.7 1 1.4 3.2 1.4 3.2" stroke-linecap="round"/>
          <path d="M151.7 27.6c-2.3.1-2.6 2.5-2.6 2.5l4.4 1s2.3-2.8-.7-3.4l-1.1-.1z"/>
        </svg>
        <div class="text-lg font-laila font-semibold text-transparent bg-clip-text bg-gradient-to-tr from-yellow-400 to-yellow-100">
