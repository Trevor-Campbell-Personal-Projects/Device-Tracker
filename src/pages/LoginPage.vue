        ...
        <div class="relative overflow-hidden bg-white rounded-2xl lg:rounded-3xl">
          <div class="px-6 py-7 sm:px-12 sm:py-10">
            <div class="text-center">
              <h1 class="text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl">Welcome Back!</h1>

              <a
                href="#"
                title=""
                class="flex items-center justify-center w-full px-8 py-4 mt-12 text-base font-bold text-gray-900 transition-all duration-200 bg-gray-100 border border-transparent rounded-xl hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black"
                role="button"
            ...
            <p class="mt-8 text-sm font-normal text-center text-gray-600">OR sign in with email...</p>

            <form action="#" method="POST" class="mt-8 bg-gray-100 p-4 rounded-lg" @submit.prevent="handleLogin()">
              <div class="space-y-4">
                <div>
            ...
            <p class="mt-5 text-base font-normal text-center text-gray-900">
              Don’t have an account?

              <router-link
                to="/register"
                title=""
                class="font-bold rounded hover:underline focus:outline-none focus:ring-1 focus:ring-gray-900 focus:ring-offset-2"
              >
                Create Free Account
              </router-link>
            </p>
